...
public class StudentDashboardPanel extends JPanel {
	...
	private void chargerDonnees() {
		...
		if (dossiers.isEmpty()) {
			...
			for (Dossier d : dossiers) {
				listPanel.add(
						createDossierRow(d.getType(), d.getDescription(), d.getStatut(), sdf.format(d.getDateMaj())));
	...
	private JPanel createDossierRow(String type, String desc, String statut, String dateMaj) {
		...
		switch (statut) {
		case "ACCEPTEE":
			lblStatut.setForeground(new Color(0x10B981));
			break;
		case "EN_ATTENTE":
		case "EN_COURS":
			lblStatut.setForeground(new Color(0xF59E0B));
			break;
		default:
			lblStatut.setForeground(new Color(0xEF4444));
		}
